...
import DesignedByYou from "images/values/DesignedByYou.svg"
import SoldWithIntegrity from "images/values/SoldWithIntegrity.svg"
import CraftedToWear from "images/values/CraftedToWear.svg"
...
export default function Values() {
  return (
    <section className="bg-white py-10 mt-3 border-y-gold border-2">
