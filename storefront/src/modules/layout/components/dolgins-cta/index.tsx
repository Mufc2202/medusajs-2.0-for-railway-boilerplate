...
import ImageCTA from "/src/images/cta.jpg"
...
const DolginsCTA = ({
  ...
  return (
    <div className="relative bg-dolginsblue m-8">
      <div className="relative h-80 overflow-hidden bg-dolginsblue md:absolute md:left-0 md:h-full md:w-1/3 lg:w-1/2">
        <Image
          alt={imageAlt}
          src={imageSrc}
